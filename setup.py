...
setup(
    ...
    name='quantificationlib',  # Required
    ...
    version=get_version("quantificationlib/__init__.py"),  # Required

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description='quantificationlib: A library for Quantification Learning',  # Optional
    ...
    download_url='https://github.com/AICGijon/quantificationlib/archive/refs/tags/0.1.2.tar.gz',
